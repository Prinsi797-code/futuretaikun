                    ...
                    <table class="table table-hover mb-0">
                        <thead class="table-light sticky-top" style="z-index: 1;">
                            <tr>
                                ...
                                <th scope="col" style="min-width: 80px; text-align: center;">Product/Logo</th>
                                <th scope="col" style="min-width: 80px; text-align: center;">Edit Profile</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="bi bi-pencil-square text-primary d-flex justify-content-center"
                                            style="cursor: pointer; font-size: 20px;" data-id="{{ $investor->id }}"
                                            data-business-logo="{{ $investor->business_logo_admin }}"
                                            data-photo="{{ $investor->photo_admin }}" data-bs-toggle="modal"
                                            data-bs-target="#InvestorphotoLogo" title="Edit Products/Logo"></i>
                                    </td>
                                    <td>
                    ...
                    <div class="resume-section">
                        ...
                        <div class="info-grid">
                         ${button.dataset.existing_company == '1' ? `
                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                    `<img src="/storage/investor_logos/${button.dataset.business_logo_admin.trim()}" alt="Business Logo" class="product-image" onclick="showImagePopup('/storage/investor_logos/${button.dataset.business_logo_admin.trim()}')">` : 
                                                                                        (button.dataset.business_logo ? 
                                                                                            `<img src="/storage/investor_logos/${button.dataset.business_logo.trim()}" alt="Business Logo" class="product-image" onclick="showImagePopup('/storage/investor_logos/${button.dataset.business_logo.trim()}')">` : 
                                                                                            'N/A'
                                                                                        )
                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ` : ''}
                            <div class="info-item">
    <span class="info-label">Investor Photo:</span>
    ${button.dataset.photo_admin ? 
        `<img src="/storage/investor_photo/${button.dataset.photo_admin.trim()}" alt="Investor Photo" class="product-image" onclick="showImagePopup('/storage/investor_photo/${button.dataset.photo_admin.trim()}')">` : 
        (button.dataset.photo ? 
            `<img src="/storage/investor_photo/${button.dataset.photo.trim()}" alt="Investor Photo" class="product-image" onclick="showImagePopup('/storage/investor_photo/${button.dataset.photo.trim()}')">` : 
            'N/A'
        )
    }
</div>
