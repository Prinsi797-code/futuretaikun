...
@section('content')
                        ...
                        <tbody>
                            @foreach ($companies as $company)
                                <tr>
                                    ...
                                    <td>{{ number_format($company->more_market_capital, 2) }}</td>
                                    <td>{{ number_format($company->more_your_stake, 2) }}</td>
                                    <td>{{ number_format($company->more_stake_funding, 2) }}</td>
                                    {{-- <td>
            ...
            <div class="modal fade" id="addCompanyModal" tabindex="-1" aria-labelledby="addCompanyModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('company.store') }}" id="addForm">
                            @csrf
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label class="form-label">Company Name</label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Investment</label>
                                    <input type="number" name="more_market_capital" class="form-control investment"
                                        step="0.01" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Equity Holding (%)</label>
                                    <input type="number" name="more_your_stake" class="form-control equity"
                                        min="0" max="100" step="0.01" required>
                                    <div class="text-danger mt-1 d-none equity-error"></div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Company Valuation</label>
                                    <input type="text" name="more_stake_funding" class="form-control valuation"
                                        readonly>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script>
        ...
        function calculateValuation(triggerElement) {
            ...
            const investmentInput = form.querySelector('input[name="more_market_capital"]');
            const equityInput = form.querySelector('input[name="more_your_stake"]');
            const valuationInput = form.querySelector('input[name="more_stake_funding"]');
